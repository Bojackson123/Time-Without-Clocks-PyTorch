...
class Parameters :
    def __init__(self, C) :
        ...
        self.params['Tmin'] ={'d2':[100.0*C, 100.0*C, 5.0*C, 0.15*C]}         # min of threshold

        self.params['Tmax'] ={'d2':[340.0*C, 400.0*C, 35.0*C, 0.55*C]}         # max of threshold
        ...
        self.params['visuals'] = True               # Whether we'll use a visual interface
